"""Self-registration endpoint for the Data Dictionary's MCP tools, fired by
...
Also callable directly (POST /services/data_dictionary/autoregister) as a one-shot.
